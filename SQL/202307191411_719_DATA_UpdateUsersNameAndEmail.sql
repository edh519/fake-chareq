-- 20230719 jw3677:	Created script to update name and/or email of a user by their username.

-- Change the following 4 variables to their expected values.
DECLARE @Username	VARCHAR(MAX) = 'jw3677';				-- case insensitive, e.g. 'abc123'
DECLARE @Firstname	VARCHAR(MAX) = 'Jenna';					-- e.g. 'Firstname'
DECLARE @FullName	VARCHAR(MAX) = 'Jenna Ward';			-- e.g. 'Firstname Lastname'
DECLARE @Email		VARCHAR(MAX) = 'jen.ward@york.ac.uk';	-- e.g. 'firstname.lastname@york.ac.uk'
